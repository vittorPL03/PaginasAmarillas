...
public class ActualizarUsuario {
    ...
    static void main(String[] args) {
        ...
        try {
            ...
            miSesion.createQuery("update Usuario set apellido='Lopez' where apellido LIKE 'P%'").executeUpdate();


            //ES el mismo proceso para el DELETE solo tener mucho cuidado con el WHERE por que sin el se eliminan todos los registros
            miSesion.createQuery("delete Usuario where nombre = 'Victor'").executeUpdate();
