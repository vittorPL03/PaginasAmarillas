...
public class ActualizarComercio {
    ...
    static void main(String[] args) {
        ...
        try {
            ...
            int comercioId = 1; // Cualquiera que exista

            // Se inicia la transaccion
            miSesion.beginTransaction();

            //Se crea un objeto para obtener el campo nombre almacenado en la base con el id_Usuario anterior
            Comercio miComercio = miSesion.getReference(Comercio.class, comercioId);
            ...
            miComercio.setNombre_Comercio("Bar don Periñon");
            ...
            // miSesion.createQuery("update Comercio set nombre_Comercio='Asadero El Pollo' where nombre_Comercio LIKE 'P%'").executeUpdate();


            //ES el mismo proceso para el DELETE solo tener mucho cuidado con el WHERE por que sin el se eliminan todos los registros

            // miSesion.createQuery("delete Comercio where nombre_Comercio = 'Bar don Periñon'").executeUpdate();
